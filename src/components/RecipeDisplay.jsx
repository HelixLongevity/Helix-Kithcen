    ...
    <div className="animate-fade-in space-y-4">
      ...
      <div className="hk-card overflow-hidden">
        ...
        <div className="hk-hero px-6 pt-8 pb-6">
          ...
          {/* Photo — loads in browser, gradient shows while loading or if absent */}
          {heroImg && (
            <img
              src={heroImg}
              alt={recipe.title}
          ...
          {heroImg && (
            <div style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to bottom, rgba(10,22,40,0.35) 0%, rgba(10,22,40,0.70) 55%, rgba(10,22,40,0.93) 100%)',
              borderRadius: 'inherit',
            }} />
          )}

          {/* All text content sits above the image + overlay */}
